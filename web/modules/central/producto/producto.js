...
document.getElementById("btnAgregarP").addEventListener('click', function (event) {
    ...
    if (v_nombre && v_nombreGenerico && v_FormaFarmaceutica && v_unidadMedida && v_principalIndicacion && v_presentacion && v_Contraindicaciones && v_Concentración && v_UnidadesEnvase && v_precioV && v_precioCompra && v_rutaFoto && v_codigoBarras) {
        insertarProducto();
    } else {
