...
{
    int idProducto;
    String nombre, nombreGenerico, formaFarmaceutica,unidadMedida,presentacion,principalIndicacion,contraindicaciones;
    String concentracion;
    int unidadesEnvase;
    float precioCompra , precioVenta;
    String foto, rutaFoto, codigoBarras;
    int estatus;
