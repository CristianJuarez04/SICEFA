...
document.getElementById("btnAdd").addEventListener('click', function (event) {
    ...
    if (v_nombre && v_apellidoPaterno && v_apellidoMaterno && v_genero && v_fecha_nacimiento && v_rfc && v_curp && v_direccion && v_codigoPostal && v_ciudad && v_estado && v_telefono && v_sucursal
            && v_rol && v_puesto && v_salario && v_codigo) {
        insertarEmpleado();
    } else {
